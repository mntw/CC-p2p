\begin{frame}		
	...
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{sr-1}}
	\end{figure}
...
\begin{frame}		
	...
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{sr-2}}
	\end{figure}
...
\begin{frame}		
	...
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{sr-3}}
	\end{figure}
...
\begin{frame}		
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}  %%<--- here
			\begin{center}
				\begin{figure}[H]
					\center{\includegraphics[width = 1\textwidth]{sr-rtt}}
				\end{figure}
			\end{center}
			\centering 
		\end{column}
		\begin{column}{0.5\textwidth}  %%<--- here
			\begin{center}
				\begin{figure}[H]
					\center{\includegraphics[width = 1\textwidth]{sr-plr}}
				\end{figure}
			\end{center}
			\centering 
		\end{column}
